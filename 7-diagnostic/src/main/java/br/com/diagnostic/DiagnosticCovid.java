...
public class DiagnosticCovid extends Diagnostic {

    public DiagnosticCovid(String disease, List<String> commonSymptomsOfTheDisease, List<String> patientSymptoms) {
